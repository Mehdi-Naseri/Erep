...
namespace Erep.Areas.Management.Controllers
{
    public class LogsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DateTime,Message,Timestamp")] Log log)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DateTime,Message,Timestamp")] Log log)
        {
            if (ModelState.IsValid)
            {
